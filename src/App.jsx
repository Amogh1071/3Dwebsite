...
const App = () => {
    ...
    return (
        <div className="app-container">
            ...
            {currentZone === 'zone3' && (
                <Zone3 glbPath="src/assets/Industrial_Final.glb" hdriPath="src/assets/evening-sky_1K_7400e4fc-d4c9-4655-b7a5-2cd52742b909.exr" onPortalEnter={handleEnterPortal} />
            )}
            {currentZone === 'zone4' && (
