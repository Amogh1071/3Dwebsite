...
const CustomEnvironment = ({ glbPath, hdriPath, onPortalEnter }) => {
    ...
    useEffect(() => {
        ...
        const ambientLight = new THREE.AmbientLight(0xffffff, 0.1); // Increased from 0.2
        scene.add(ambientLight);

        // Main directional light with shadows
        const directionalLight = new THREE.DirectionalLight(0xffffff, 3); // Reduced from 1.2
        ...
        const fillLight = new THREE.DirectionalLight(0xffffff, 0.3); // Reduced from 1.0
